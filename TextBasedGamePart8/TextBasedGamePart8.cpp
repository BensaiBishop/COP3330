...
bbishop@linprog4.cs.fsu.edu:~/COP3330/textGame8>make
g++ -std=c++11 -c TextBasedGamePart8.cpp
g++ -std=c++11 -c Room.h
...
g++ -std=c++11 TextBasedGamePart8.o Room.o User.o SuperUser.o -o TextGame
bbishop@linprog4.cs.fsu.edu:~/COP3330/textGame8>Textgame
Textgame: Command not found.
bbishop@linprog4.cs.fsu.edu:~/COP3330/textGame8>TextGame
...
p
You don't feel the power of SUPER
...
Where do you move? N,S,E,W
p
You pray to a higher power for guidance. You find yourself elsewhere.
...
Where do you move? N,S,E,W
m
You must be a SuperUser to be given a moniker
...
n
Thank you for playing...
bbishop@linprog4.cs.fsu.edu:~/COP3330/textGame8>
